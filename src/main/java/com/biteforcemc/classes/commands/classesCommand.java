package com.biteforcemc.classes.commands;
...
public class classesCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("classes")) {
            ...
            if (args[0].equalsIgnoreCase("give") && player.hasPermission("biteforcemc.classes.give")) {
            ...
            if (args[0].equalsIgnoreCase("set") && player.hasPermission("biteforcemc.classes.set")) {
